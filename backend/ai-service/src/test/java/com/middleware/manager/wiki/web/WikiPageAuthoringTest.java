...
class WikiPageAuthoringTest {
    ...
    void managerCanCreatePage() {
        ...
        assertThat(response.getBody().getPage().getStatus()).isEqualTo("DRAFT");
    ...
    void blankTitleRejected() {
        ...
        ResponseEntity<WikiPageSaveResponse> response = controller.createPage(blank, authentication, request);
